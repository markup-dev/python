...
# Шаг 1 - выкачиваем картинки с https://course.urban-university.ru/profession-python

html = requests.get('https://course.urban-university.ru/profession-python').text
